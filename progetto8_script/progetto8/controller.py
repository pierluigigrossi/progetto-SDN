# Blocco Traffico TCP Anomalo (oltre-soglia)
# Se una destinazione riceve più di X nuove connessioni TCP, contate con i SYN
# nell’ultimo intervallo T 
# la nuova connessione è bloccata. Siano X e T valori arbitrari.
...
T = 10 #intervallo di tempo in secondi
